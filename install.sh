...
# Usage:
#   curl -fsSL https://raw.githubusercontent.com/Nothing-129/maxcode/main/install.sh | bash
#   curl -fsSL https://raw.githubusercontent.com/Nothing-129/maxcode/main/install.sh | bash -s -- --version v0.5.0
#
